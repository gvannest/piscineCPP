...
NinjaTrap::NinjaTrap(std::string name, int hp, int maxHp, int ep, int maxEp, unsigned int mA,
...
void        NinjaTrap::ninjaShoebox(FragTrap & frag){
    std::cout << "NinjaTrap " << this->getName() << " has launched a shit bag attack on "
            << frag.getName() << " inflicting him 20 points in damages!" << std::endl;
    frag.takeDamage(20);
}

void        NinjaTrap::ninjaShoebox(ScavTrap & scav){
    std::cout << "NinjaTrap " << this->getName() << " has launched a toad attack on "
            << scav.getName() << " inflicting him 25 points in damages!" << std::endl;
    scav.takeDamage(25);
}

void        NinjaTrap::ninjaShoebox(NinjaTrap & ninja){
    std::cout << "NinjaTrap " << this->getName() << " has launched a developer socks attack on "
